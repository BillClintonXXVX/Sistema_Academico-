                  ...
                  <div class="x_content">
                    ...
                    <form class="form-horizontal form-label-left" method="POST" action="OperacionActualizar/ActualizarPresentePeriodoAcad.php">
                        ...
                        <div class="item form-group">
															<label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">EDITAR
																<span class="required">:</span>
															</label>
															<div class="col-md-6 col-sm-6 col-xs-12">
															<select name="id_periodo_acad" id="id_periodo_acad" class="form-control col-md-7 col-xs-12" value="4">
